...
class signupSerializer(Serializer):
    ...
    def create(self, validated_data):
        ...
        user=User.objects.create_user(username=mobile_number,email=email,password=password,first_name=first_name,last_name=last_name)
        user.save()
        ...
        profileO.referral_code=self.validated_data['referral_code']
...
class  NewsRequestCreateSerializer(Serializer):
    ...
    service_provider = CharField(error_messages={'required':'service_provider is required', 'blank':'service_provider is required'},max_length=400)
    description = CharField(error_messages={'required':'description is required', 'blank':'description is required'},max_length=400)
    def validate(self, data):
    ...
    def create(self, validated_data):
        ...
        user=UserReguest.objects.create(user=user,request_id=request_id,name=name,description=description,service_provider=service_provider)
